...
def text_field_send_keys(
    web_driver: WebDriverWait, html_id_element: str, send_info: str
):
    text_field = web_driver.until(
        ec.visibility_of_element_located((By.ID, html_id_element))
    )
